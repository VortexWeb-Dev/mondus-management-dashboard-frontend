...
const TransactionTable = () => {
  ...
  useEffect(() => {
    fetchData(
      branch == "Mondus"
        ? import.meta.env.VITE_OVERALL_DEALS
        : import.meta.env.VITE_OVERALL_DEALS_CFT,
      {},
      setIsLoading,
      setError
    ).then((data) => {
  ...
  const filteredTransactions = useMemo(() => {
    ...
    return transactions.filter((transaction) => {
      ...
      return (
        (filters.year.length === 0 || filters.year.includes(year)) &&
        (filters.dealType.length === 0 ||
          filters.dealType.includes(transaction.dealType)) &&
        (filters.transactionType.length === 0 ||
          filters.transactionType.includes(transaction.transactionType)) &&
        (filters.leadSource.length === 0 ||
          filters.leadSource.includes(transaction.leadSource)) &&
        (filters.propertyType.length === 0 ||
          filters.propertyType.includes(transaction.propertyType))
      );
    });
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          ...
          <div className="relative">
            ...
            >
              ...
              {countActiveFilters("transactionType") > 0 && (
                <span className="ml-1 bg-blue-600 text-white rounded-full w-5 h-5 flex items-center justify-center text-xs">
                  {countActiveFilters("transactionType")}
                </span>
              )}
              <ChevronDown className="w-4 h-4 ml-2" />
            </button>
          ...
          <div className="relative">
            ...
            >
              ...
              {countActiveFilters("propertyType") > 0 && (
                <span className="ml-1 bg-blue-600 text-white rounded-full w-5 h-5 flex items-center justify-center text-xs">
                  {countActiveFilters("propertyType")}
                </span>
              )}
              <ChevronDown className="w-4 h-4 ml-2" />
            </button>
          ...
          <tbody className="bg-white divide-y divide-gray-200 dark:bg-gray-900 dark:divide-gray-700">
            {sortedTransactions.length > 0 ? (
              sortedTransactions.map((transaction, index) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-200 text-right">
                    {transaction.propertyPrice.toLocaleString("en-US", {
                      style: "currency",
                      currency: "AED",
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-200 text-right">
                    {transaction.grossCommission.toLocaleString("en-US", {
                      style: "currency",
                      currency: "AED",
                      maximumFractionDigits: 0,
                    })}
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-200 text-right">
                    {transaction.grossCommissionInclVAT.toLocaleString(
                      "en-US",
                      {
                        style: "currency",
                        currency: "AED",
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-200 text-right">
                    {transaction.agentCommission.toLocaleString("en-US", {
                      style: "currency",
                      currency: "AED",
                      maximumFractionDigits: 0,
                    })}
              ...
              <tr>
                <td
                  colSpan="10"
                  className="px-6 py-10 text-center whitespace-nowrap text-sm text-gray-500 dark:text-gray-400"
                >
